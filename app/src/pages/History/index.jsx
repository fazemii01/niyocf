          ...
          <section className="flex flex-col-reverse md:flex-row gap-5 md:w-[80vw] duration-200">
            ...
            <aside className="flex-1 flex flex-col gap-1 text-sm">
              ...
              <div className="flex justify-between">
                <p className="font-poppins font-semibold">Grand Total</p>
                <p>IDR {n_f(dataDetail.grand_total)}</p>
              </div>
              <div className="flex justify-between">
                <p className="font-poppins font-semibold">Payment Method</p>
                <p>{dataDetail.payment_name}</p>
              </div>
              <div className="flex justify-between">
                <p className="font-poppins font-semibold">Status</p>
                <p>{dataDetail.status_name}</p>
              </div>
              <div className="flex justify-between">
                <p className="font-poppins font-semibold">Delivery Type</p>
                <p>{dataDetail.delivery_name}</p>
              </div>
              <div className="flex justify-between">
                <p className="font-poppins font-semibold">Transaction at</p>
                <p>{formatDateTime(dataDetail.transaction_time)}</p>
              </div>
              <div className="flex flex-col mt-1">
                <p className="font-poppins font-semibold">Delivery address</p>
                <p className="break-words">
                  {dataDetail.delivery_address || "no address"}
                </p>
              </div>
              <div className="flex flex-col mt-1">
                <p className="font-poppins font-semibold">Notes</p>
